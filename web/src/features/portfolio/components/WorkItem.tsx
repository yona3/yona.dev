...
import type { WorkItemProps } from "@/features/portfolio/types";
...
export const WorkItem: FC<WorkItemProps> = ({
  ...
  const contents = (
    <div
      className="
        h-64 cursor-pointer rounded-md border
        border-gray-800 shadow transition duration-500
        sm:h-72 md:hover:opacity-70
      "
    >
      <div className="relative z-0 h-40 overflow-hidden rounded-t-md border-b bg-gray-800 sm:h-48">
        <Image
          src={image}
          fill
